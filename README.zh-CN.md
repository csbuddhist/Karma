...
新用户可从 [v0.1.12 Windows Test Build](https://github.com/csbuddhist/Karma/releases/tag/v0.1.12) 下载单文件 `Karma-windows-x64-test-v0.1.12-setup.exe`，在 Windows 10 22H2 或 Windows 11 x64 上以管理员身份运行即可完成文件安装、哈希校验、Service 注册和快捷方式创建。安装前仍需安装 Microsoft Visual C++ 2015–2022 x64 Redistributable。
