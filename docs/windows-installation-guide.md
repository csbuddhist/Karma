...
新用户从 [v0.1.10 Windows Test Build](https://github.com/DrWeiZhou/Karma/releases/tag/v0.1.10) 下载：

```text
Karma-windows-x64-test-v0.1.10-setup.exe
```
...
bash tools/package-windows-installer/build_installer.sh 0.1.10
```

生成文件：

```text
target/release-artifacts/Karma-windows-x64-test-v0.1.10-setup.exe
```
